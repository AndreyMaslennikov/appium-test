...
class DeploymentReleasesImpl {
     ...
     */
    update(deploymentName, releaseLabel, ownerName, appName, release, options) {
        return this.client.sendOperationRequest({ deploymentName, releaseLabel, ownerName, appName, release, options }, updateOperationSpec);
    }
}
