...
let AppUpdateCommand = class AppUpdateCommand extends commandline_1.AppCommand {
    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const app = this.app;
            try {
                const updateAppResponse = yield interaction_1.out.progress("Updating app ...", client.apps.update(app.ownerName, app.appName));
                format_app_1.reportApp(updateAppResponse);
            }
            catch (error) {
