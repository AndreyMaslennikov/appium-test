...
let ProfileConfigureCommand = class ProfileConfigureCommand extends commandline_1.Command {
    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            const profile = yield interaction_1.out.progress("Getting current user profile...", client.users.get());
            const questions = [
                {
                    type: "input",
                    name: "displayName",
            ...
            if (anyChanged) {
                const updated = yield interaction_1.out.progress("Updating user profile...", client.users.update({ displayName: answers.displayName }));
