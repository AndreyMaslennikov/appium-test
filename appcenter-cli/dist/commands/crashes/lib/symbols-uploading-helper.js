...
class SymbolsUploadingHelper {
    ...
    uploadSymbolsArtifact(artifactPath, symbolType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield new azure_blob_upload_helper_1.default().upload(uploadUrl, artifactPath);
    ...
    executeSymbolsUploadingBeginRequest(client, app, symbolType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield client.symbolUploads.create(app.ownerName, app.appName, symbolType);
            }
            catch (error) {
    ...
    executeSymbolsUploadingEndRequest(client, app, symbolUploadId, desiredStatus) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield client.symbolUploads.complete(symbolUploadId, app.ownerName, app.appName, desiredStatus);
            }
            catch (error) {
