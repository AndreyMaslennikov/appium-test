...
let ListDistributionGroupsCommand = class ListDistributionGroupsCommand extends commandline_1.AppCommand {
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                distributionGroupsListRequestResponse = yield interaction_1.out.progress("Getting list of the distribution groups...", client.distributionGroups.list(app.ownerName, app.appName));
            }
            catch (error) {
            ...
            for (const distributionGroupName of distributionGroupsNames) {
                distributionGroupUsersPromises.push(limit(() => client.distributionGroups.listUsers(this.app.ownerName, this.app.appName, distributionGroupName)));
            }
