    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield interaction_1.out.progress("Rollback CodePush release...", client.codePushDeploymentRelease.rollback(this.deploymentName, app.ownerName, app.appName, { label: this.targetRelease }));
            }
            catch (error) {
