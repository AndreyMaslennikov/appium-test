...
let CodePushAddCommand = class CodePushAddCommand extends commandline_1.AppCommand {
    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let deployment;
            try {
                deployment = yield interaction_1.out.progress("Creating a new CodePush deployment...", client.codePushDeployments.create(app.ownerName, app.appName, this.newDeploymentName.toString()));
