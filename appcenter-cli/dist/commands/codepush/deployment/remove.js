    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield interaction_1.out.progress(`Removing CodePush deployment...`, client.codePushDeployments.delete(this.deploymentName.toString(), app.ownerName, app.appName));
            }
            catch (error) {
